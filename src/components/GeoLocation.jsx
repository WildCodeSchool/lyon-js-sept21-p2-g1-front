...
Geocode.setApiKey('AIzaSyAllxS_YzDHgJIGlXJlvYszWVM7OniCyUU');
Geocode.enableDebug();

const Geolocation = class LocationSearchModal extends React.Component {
  ...
  constructor() {
    ...
    this.state = {
      ...
      // AsyncMap = compose(
      //       withProps({
      //           googleMapURL: "https://maps.googleapis.com/maps/api/js?key=AIzaSyAllxS_YzDHgJIGlXJlvYszWVM7OniCyUU&v=3.exp&libraries=geometry,drawing,places",
      ...
      render() {
              ...
              >
                <div>
                  <span style={{ padding: 0, margin: 0 }}>
                    {/* {this.state.address} */ <h1>Hello</h1>}
                  </span>
                </div>
              </InfoWindow>
              <Marker />
        ...
        return (
          ...
          <Descriptions.Item label="Address">
            ...
            <AsyncMap
              googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyAllxS_YzDHgJIGlXJlvYszWVM7OniCyUU&libraries=places"
              loadingElement={<div style={{ height: `100%` }} />}
